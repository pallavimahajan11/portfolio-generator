...
const Form = ({ FormData, onChange }) => {
  const Desc = {
    ...
    Facebook: ["text", "Facebook profile", "Mention your Facebook profile link"],
    Instagram: ["text", "Instagram profile", "Mention your Instagram profile link"],
    Twitter: ["text", "Twitter profile", "Mention your Twitter profile link"],
    LinkedIn: ["text", "LinkedIn profile", "Mention your LinkedIn profile link"],
    GitHub: ["text", "Github profile", "Mention your Github profile link"],
    Coding: ["text", "Coding profile", "Mention your Coding profile link"],
    Keywords: [
      "text",
      "Keywords",
