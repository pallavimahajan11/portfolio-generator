...
const Code = ({
  ...
  const Meta = {
    ...
    Coding: ["far fa-file-code", Coding]
  };
  return (
    <div className="Code">
...
<html lang="en">
  <head>
    ...
    .text-primary {--bs-text-opacity: 1; color: ${Colour} !important;}
      .r:hover {--bs-bg-opacity: 1; background-color: ${Colour} !important;}
    </style>
  </head>
  <body id="page-top">
     <!-- Navigation-->
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav">
          ...
          ${experiences.length !== 0 ? `<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#experience">Experience</a></li>` : ""}
          ${educations.length !== 0 ? `<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#education">Education</a></li>` : ""}
          ${skills.length !== 0 ? `<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#skills">Skills</a></li>` : ""}
          ${interests.length !== 0 ? `<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#interests">Interests</a></li>` : ""}
          ${awards.length !== 0 ? `<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#awards">Awards</a></li>` : ""}
        </ul>
      </div>
    </nav>
    <!-- Page Content-->
...
${Object.keys(Socials).map(
          soc =>
            ` ${Meta[soc][1].length !== 0 ? `<a class="r social-icon" target="_blank" href="${Meta[soc][1]}${Socials[soc]}"><i class="${Meta[soc][0]}"></i></a>` : ""}`
        ).join(`
`)}
          </div>
        </div>
